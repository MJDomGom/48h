...
<html>
    <head>
        ...
        <title>Listado Estadísticas - 48h</title>
            ...
            <section class="clean-block slider dark">
                <div class="container">
                    ...
                    <div class="block-heading text-center">
                        <h2 class="text-dark shadow">LISTADO DE ESTADÍSTICAS</h2>
                        <div style="margin-top: 25px; margin-bottom: 20px;">
                            <p>Estadísticas registradas en el sistema:</p>
                        </div>
                    </div>
                    ...
                    <table class="table" style="margin-top: 10px; margin-bottom: 15px">
                        <thead>
                            <tr>
                                ...
                                <th class="shadow-sm" style="text-align: center;">Resultado (L-V)</th>
                                <th class="shadow-sm" style="text-align: center;">Tiros a puerta (L-V)</th>
                                <th class="shadow-sm" style="text-align: center;">Amarillas (L-V)</th>
                                <th class="shadow-sm" style="text-align: center;">Rojas (L-V)</th>   
                                <th class="shadow-sm" style="text-align: center;">Azules (L-V)</th> 
                                    <s:if test="%{#session.rol == 'Gerente'}">
                        ...
                        <tbody>
                            <s:iterator value="listaEstadisticas">
                                <tr>
                                    ...
                                    <td class="text-center"><s:property value="%{rojas}"></s:property></td>
                                    <td class="text-center"><s:property value="%{azules}"></s:property></td>
                                    <s:if test="%{#session.rol == 'Gerente'}">
