                ...
                <div class="container">
                    <div class="block-heading text-center">
                        ...
                        <div style="margin-top: 25px; margin-bottom: 20px;">
                            <p>Introduce los datos para registrar un partido:</p>
                        </div>
                    </div>
                    <section class="text-light d-inline-block float-none d-lg-flex justify-content-lg-center" style="background: rgb(246,246,246); margin-top: 30px; padding-right: 230px;">
                        <div class="form-container">
                            <s:form action="addPartido" method="post">
                                ...
                                <div class="form-group"><s:checkbox name="equipos" fieldValue="false" label="Local y Visitante" value="listaEquipos" cssStyle="height: 16px; width: 100px; margin-top: 10px; margin-bottom: 20px; margin-left: 20px;"/></div>
