...
<html>
    <head>
        ...
        <title>Listado Integrantes - 48h</title>
                ...
                <div class="container">
                    ...
                    <div class="block-heading text-center">
                        ...
                        <div style="margin-top: 25px; margin-bottom: 20px;">
                            <p>Integrantes de los equipos registrados en el sistema:</p>
                        </div>
                    </div>
                    <s:form action="addIntegranteRedirect">
                        <s:submit name="integrante" cssClass="btn btn-primary text-light bg-dark border-light" value="Añadir Jugadores"></s:submit>
                    </s:form>
                    <div class="table-responsive">
                        <table class="table" style="margin-top: 10px; margin-bottom: 15px">
                            <thead>
                                <tr>
                                    <th class="shadow-sm" style="text-align: center;">DNI</th>
                            ...
                            <tbody>
                                <s:iterator value="listaIntegrante">
                                    <tr>
                                        <td class="text-center"><s:property value="%{dni}"></s:property></td>
                                        <td class="text-center"><s:property value="%{nombre}"></s:property></td>
                                        <td class="text-center"><s:property value="%{apellidos}"></s:property></td>
                                        <td class="text-center"><s:property value="%{dorsal}"></s:property></td>
                                        <td class="text-center"><s:property value="%{nombreEquipo}"></s:property></td>
                                        <s:if test="%{#session.rol == 'Gerente'}">
                                            <td style="width: 33px; margin: 0 auto;">
                                                <s:form action="updateIntegranteRedirect">
                                                    <s:hidden name="oculto" value="%{dni}"></s:hidden>
                                                    <s:submit name="modificar" cssClass="btn btn-primary text-light bg-dark border-light" value="Modificar"></s:submit>
                                                </s:form>
                                            </td>
                                            <td style="width: 33px; margin: 0 auto;">
                                                <s:form action="deleteIntegrante">
                                                    <s:hidden name="oculto" value="%{dni}"></s:hidden>
                                                    <s:submit name="delete" cssClass="btn btn-primary text-light bg-dark border-light" value="Borrar"></s:submit>
                                                </s:form>
                                            </td>
                                        </s:if>
                                    </tr>
