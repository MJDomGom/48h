                    ...
                    <section class="text-light d-inline-block float-none d-lg-flex justify-content-lg-center" style="background: rgb(246,246,246); margin-top: 30px; padding-right: 80px;">
                        <div class="form-container">
                            <s:form action="updateIntegrante">  
                                ...
                                <div class="form-group"><s:textfield name="nombre"  label="Nombre" class="form-control" cssStyle="height: 40px; width: 500px; margin: 10px; text-align: center;"></s:textfield></div>
                                <div class="form-group"><s:textfield name="apellidos"  label="Apellidos" class="form-control" cssStyle="height: 40px; width: 500px; margin: 10px; text-align: center;"></s:textfield></div>
                                <div class="form-group"><s:textfield name="dorsal" type="number" min="1" max="99" label="Dorsal" class="form-control" cssStyle="height: 40px; width: 500px; margin: 10px; text-align: center;"></s:textfield></div>
                                <div class="form-group"><s:select label="Equipo" 
