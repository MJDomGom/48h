...
<html>
    <head>
        ...
        <title>Listado Partidos - 48h</title>
            ...
            <section class="clean-block slider dark">
                <div class="container">
                    ...
                    <div class="block-heading text-center">
                        <h2 class="text-dark shadow">LISTADO DE PARTIDOS</h2>
                        ...
                        <table class="table" style="margin-top: 10px; margin-bottom: 15px">
                            <thead>
                                <tr>
                                    ...
                                    <th class="shadow-sm" style="text-align: center;">Fecha</th>
                                    <th class="shadow-sm" style="text-align: center;">Instalacion</th>
                                        <s:if test="%{#session.rol == 'Gerente'}">
