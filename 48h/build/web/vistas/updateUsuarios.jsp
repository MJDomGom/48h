                    ...
                    <section class="text-light d-inline-block float-none d-lg-flex justify-content-lg-center" style="background: rgb(246,246,246); margin-top: 30px; padding-right: 100px;">
                        <div class="form-container">
                            <s:form action="updateUsuario">
                                <div class="form-group"><s:textfield name="nombreUpd" class="form-control" cssStyle="height: 40px; width: 500px; margin: 10px; text-align: center;" label="Nombre Usuario" value="%{session.NombreUpd}"></s:textfield></div>
                                <div class="form-group"><s:textfield name="passUpd" class="form-control" cssStyle="height: 40px; width: 500px; margin: 10px; text-align: center;" label="Contraseña" value="%{session.PassUpd}"></s:textfield></div>
