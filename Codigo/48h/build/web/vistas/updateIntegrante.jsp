...
<html>
    <head>
        ...
        <title>Modificar Integrante - 48h</title>
            ...
            <section class="clean-block slider dark" style="background: rgb(246, 246, 246);">
                <div class="container">
                    <div class="block-heading text-center">
                        <h2 class="text-dark shadow">MODIFICAR INTEGRANTE</h2>
                        <div style="margin-top: 25px; margin-bottom: 20px;">
                            <p>Actualiza los datos de este integrante:</p>
                        </div>
                    </div>
                    <section class="text-light d-inline-block float-none d-lg-flex justify-content-lg-center" style="background: rgb(246,246,246); margin-top: 30px; padding-right: 80px;">
                        <div class="form-container">
                            <s:form action="updateIntegrante">  
                                <s:hidden name="oculto"></s:hidden>
                                <div class="form-group"><s:textfield name="nombre"  label="Nombre" id="nameFieldId" class="form-control" cssStyle="height: 40px; width: 500px; margin: 10px; text-align: center;"></s:textfield></div>
                                <div class="form-group"><s:textfield name="apellidos"  label="Apellidos" id="nameFieldId" class="form-control" cssStyle="height: 40px; width: 500px; margin: 10px; text-align: center;"></s:textfield></div>
                                <div class="form-group"><s:textfield name="dorsal" type="number" min="1" max="99" label="Dorsal" id="nameFieldId" class="form-control" cssStyle="height: 40px; width: 500px; margin: 10px; text-align: center;"></s:textfield></div>
                                <div class="form-group"><s:select label="Equipo" id="nameFieldId"
