                ...
                <div class="container">
                    ...
                    <section class="text-light d-inline-block float-none d-lg-flex justify-content-lg-center" style="background: rgb(246,246,246); margin-top: 30px; padding-right: 140px;">
                        <div class="form-container">
                            ...
                            <section class="text-light d-inline-block float-none d-lg-flex justify-content-lg-center" style="background: rgb(246,246,246); margin-top: 10px; margin-bottom: 50px; padding-right: 160px;">
                                <div class="form-container">
