                    ...
                    <section class="text-light d-inline-block float-none d-lg-flex justify-content-lg-center" style="background: rgb(246,246,246); margin-top: 30px; padding-right: 100px;">
                        <div class="form-container">
                            <s:form action="updateInstalacion">
                                <div class="form-group"><s:textfield name="nombreUpd" class="form-control" cssStyle="height: 40px; width: 500px; margin: 10px; text-align: center;" label="Nombre" id="nameFieldId" value="%{session.NombreUpd}"></s:textfield></div>
                                <div class="form-group"><s:textfield name="dirUpd" id="dirUpd" class="form-control" cssStyle="height: 40px; width: 500px; margin: 10px; text-align: center;" label="Direccion" id="nameFieldId" value="%{session.DirUpd}"></s:textfield></div>
                                <div class="form-group"><s:textfield name="ciuUpd" id="ciuUpd" class="form-control" cssStyle="height: 40px; width: 500px; margin: 10px; text-align: center;" label="Ciudad" id="nameFieldId" value="%{session.CiuUpd}"></s:textfield></div>
                                <div class="form-group"><s:textfield name="capUpd" class="form-control" cssStyle="height: 40px; width: 500px; margin: 10px; text-align: center;" label = "Capacidad" id="nameFieldId" type="number" min="0" value="%{session.CapUpd}"></s:textfield></div>
                                ...
                                <s:submit name="btnupdate" cssStyle="height: 40px; width: 500px; margin: 10px;" cssClass="btn btn-primary btn-block text-light bg-dark border-light" value="Modificar"></s:submit>
                            </s:form>
