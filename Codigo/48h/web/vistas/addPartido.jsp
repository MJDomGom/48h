                ...
                <div class="container">
                    ...
                    <section class="text-light d-inline-block float-none d-lg-flex justify-content-lg-center" style="background: rgb(246,246,246); margin-top: 30px; padding-right: 240px;">
                        <div class="form-container">
                            ...
                            <section class="text-light d-inline-block float-none d-lg-flex justify-content-lg-center" style="background: rgb(246,246,246); margin-top: 10px; padding-right: 65px;">
                                <div class="form-container">
                                    <s:form action="cargarPartidos">
                                        <s:submit name = "btnCancelar" value="Cancelar" cssClass="btn btn-primary text-light bg-dark border-light" cssStyle="height: 40px; width: 200px; margin-bottom: 220px;"></s:submit>
                                    </s:form>
                                </div>
                            </section>
                        </div>
