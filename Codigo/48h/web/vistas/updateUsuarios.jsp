...
<html>
    ...
    <head>
        ...
        <title>Modificar Usuario - 48h</title>
            ...
            <section class="clean-block slider dark" style="background: rgb(246, 246, 246);">
                <div class="container">
                    <div class="block-heading text-center">
                        <h2 class="text-dark shadow">MODIFICAR USUARIO</h2>
                        <div style="margin-top: 25px; margin-bottom: 20px;">
                            <p>Actualiza los datos de este usuario:</p>
                        </div>
                    </div>
                    <section class="text-light d-inline-block float-none d-lg-flex justify-content-lg-center" style="background: rgb(246,246,246); margin-top: 30px; padding-right: 100px;">
                        <div class="form-container">
                            <s:form action="updateUsuario">
                                <div class="form-group"><s:textfield name="nombreUpd" label="Nombre de usuario" id="nameFieldId" class="form-control" cssStyle="height: 40px; width: 500px; margin: 10px; text-align: center;" label="Nombre Usuario" value="%{session.NombreUpd}"></s:textfield></div>
                                <div class="form-group"><s:textfield name="passUpd" label="Nueva contraseña" id="nameFieldId" class="form-control" cssStyle="height: 40px; width: 500px; margin: 10px; text-align: center;" label="Contraseña" value="%{session.PassUpd}"></s:textfield></div>
                            ...
                            <section style="background: rgb(246,246,246); margin-top: 10px; padding-left: 130px;">
                                <div class="form-container">
