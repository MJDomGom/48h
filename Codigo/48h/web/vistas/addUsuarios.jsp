            ...
            <section class="clean-block slider dark" style="background: rgb(246, 246, 246);">
                <div class="container">
                    <div class="block-heading text-center">
                        <h2 class="text-dark shadow">ALTA DE USUARIO</h2>
                        <div style="margin-top: 25px; margin-bottom: 20px;">
                            <p>Introduce los datos para registrar a un usuario:</p>
                        </div>
                    </div>
                    <section class="text-light d-inline-block float-none d-lg-flex justify-content-lg-center" style="background: rgb(246,246,246); margin-top: 30px; padding-left: 20px;">
                        <div class="form-container">
                            <s:form action="addUsuario" method="post">
                                <div class="form-group"><s:textfield class="form-control" cssStyle="height: 40px; width: 500px; margin: 10px; text-align: center;" name="nick" placeholder="Nick"></s:textfield></div>
                                <div class="form-group"><s:textfield class="form-control" cssStyle="height: 40px; width: 500px; margin: 10px; text-align: center;" name="nombre" placeholder="Nombre"></s:textfield></div>
                                ...
                                <s:submit name = "btnAdd" cssStyle="height: 40px; width: 500px; margin: 10px;" cssClass="btn btn-primary btn-block text-light bg-dark border-light" value="Registrar"></s:submit>
                            </s:form>
                            <section style="background: rgb(246,246,246); margin-top: 10px; padding-left: 10px;">
                                <div class="form-container">
                                    <s:form action="cargarUsuarios">
                                        <s:submit name = "btnCancelar" value="Cancelar" cssStyle="height: 40px; width: 200px; margin-bottom: 10px;" cssClass="btn btn-primary btn-block text-light bg-dark border-light"></s:submit>
                                    </s:form>
                                </div>
                            </section>
                        </div>
