                                            ...
                                            <s:if test="%{#session.rol == 'Gerente'}">
                                                <td style="width: 33px; margin: 0 auto;">
                                                    <s:form action="updateUsuarioRedirect">
                                                        ...
                                                        <s:submit name="update" cssClass="btn btn-primary text-light bg-dark border-light" value="Modificar"></s:submit>
                                                    </s:form>
                                                </td>
                                                <td style="width: 33px; margin: 0 auto;">
                                            ...
                                            <s:if test="%{nick == #session.nick}">
                                                <tr>
                                                    ...
                                                    <td style="width: 33px; margin: 0 auto;">
                                                        <s:form action="updateUsuarioRedirect">
                                                            <s:hidden name="oculto" value="%{nick}"></s:hidden>
                                                            <s:submit name="update" cssClass="btn btn-danger text-light bg-dark border-light" value="Modificar"></s:submit>
                                                        </s:form>
                                                    </td>
                                                </tr>
                                            </s:if>
